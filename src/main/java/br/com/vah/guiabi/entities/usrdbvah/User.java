...
@Entity
@Table(name = "TB_GUIABI_USUARIO", schema = "USRDBVAH")
...
public class User extends BaseEntity {
  ...
  @Id
  @SequenceGenerator(name = "seqUser", sequenceName = "SEQ_GUIABI_USUARIO", schema = "USRDBVAH", allocationSize = 1)
