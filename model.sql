...
(
  ...
  CONSTRAINT FK_GUIABI_GUIA_ANTEDIME FOREIGN KEY (CD_ATENDIMENTO) REFERENCES
);
...
ALTER TABLE USRDBVAH.TB_GUIABI_GUIA ADD CONSTRAINT FK_GUIABI_GUIA_ESPECIALID FOREIGN KEY (CD_ESPECIALIDADE) REFERENCES DBAMV.ESPECIALID (CD_ESPECIALID);
...
ALTER TABLE USRDBVAH.TB_GUIABI_COMENTARIO ADD CONSTRAINT FK_GUIABI_COMENTARIO_USUARIO FOREIGN KEY (ID_USER) REFERENCES USRDBVAH.TB_GUIABI_USUARIO (ID);
ALTER TABLE USRDBVAH.TB_GUIABI_COMENTARIO ADD CONSTRAINT FK_GUIABI_COMENTARIO_GUIA FOREIGN KEY (ID_GUIA) REFERENCES USRDBVAH.TB_GUIABI_GUIA (ID);
